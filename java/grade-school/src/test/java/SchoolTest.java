...
public class SchoolTest {
  ...
  public void sortsSchool() {
    ...
    public void foo() throws Exception {
        school.db().put(12, Arrays.asList("dwayne", "bill"));
        school.sort().put(13, Arrays.asList("tyrion", "dexter"));
        assertThat(school.grade(12)).hasSize(0);
        assertThat(school.grade(13)).hasSize(0);
