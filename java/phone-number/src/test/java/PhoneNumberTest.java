...
public class PhoneNumberTest {
    ...
    @Test
    public void foo() {
        System.out.println(new PhoneNumber("456-7890").getNumber());
        System.out.println(new PhoneNumber("456-7890").pretty());
        System.out.println(new PhoneNumber("1123)-456 7890").pretty());
    }
}
